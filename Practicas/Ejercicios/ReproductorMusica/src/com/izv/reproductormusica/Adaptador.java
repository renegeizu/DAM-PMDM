...
public class Adaptador extends CursorAdapter{
	...
	public void bindView(View v, Context co, Cursor cu) {
		String cancion = cu.getString(cu.getColumnIndex(MediaStore.Audio.Media.TITLE));
		TextView tv=(TextView) v.findViewById(R.id.tvDetalleNombre);
		tv.setText(cancion);
	}
	...
	public View newView(Context co, Cursor cu, ViewGroup vg) {
		...
		View v = i.inflate(R.layout.detalle_reproductor, vg, false);
		return v;
	}
